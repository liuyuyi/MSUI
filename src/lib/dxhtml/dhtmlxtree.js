...
dhtmlXTreeObject.prototype._createItem = function (acheck, itemObject, mode) {
    ...
    td2.style.fontSize = "10px"; td2.style.cursor = this.style_pointer;
...
dhtmlXTreeObject.prototype.getUserData = function (itemId, name) {
    var sNode = this._globalIdStorageFind(itemId, 0, true);
    if (!sNode) return;
    console.log(sNode.userData["t_" + name])
...
dhtmlXTreeObject.prototype.setItemColor = function (itemId, defaultColor, selectedColor) {
    ...
    if (!temp) return 0;
        ...
        if (temp.i_sel) { if (selectedColor) temp.span.style.color = selectedColor; }
